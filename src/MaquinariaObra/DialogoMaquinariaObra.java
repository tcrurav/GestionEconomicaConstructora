    ...
    public void nuevo() {
        ...
        try {
           ...
           // periodomaquinariaenobra.setMaquinaria(maquinaria);
            ...
            if (dba.PeriodoMaquinariaEnObraDba.insertPeriodoMaquinaraEnObra(periodomaquinariaenobra)) {
      ...
      public void modificar() {
       ...
       public void borrar() {
        ...
        try {
            ...
            if (dba.PeriodoMaquinariaEnObraDba.deletePeriodoMaquinariaEnObrea(Integer.valueOf(identificador))) {
