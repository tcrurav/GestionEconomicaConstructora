...
public class GestiónEconómicaConstructoraPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "GestiónEconómicaConstructora";
	...
	private GestiónEconómicaConstructoraPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new GestiónEconómicaConstructoraPersistentManager();
		}
